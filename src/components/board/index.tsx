  ...
  return (
    ...
    <div className="">
      <div className="flex flex-row justify-evenly sm:ml-0 md:ml-0 lg:ml-0 2xl:-ml-96">
        ...
        <div className="h-64 mr-32 bg-red-300 border-8 border-red-500 rounded-lg shadow-2xl w-80 shadow-red-500/50 hover:scale-105 sm:w-28 sm:h-24 sm:mr-20 md:w-32 md:h-28 md:mr-20 lg:w-32 lg:h-28 lg:mr-20">
        ...
        {/* Board 2 */}
        <div className="h-64 mr-24 bg-green-300 border-8 border-green-500 rounded-lg shadow-2xl w-80 shadow-green-500/50 hover:scale-105 sm:w-28 sm:h-24 sm:mr-10 md:w-32 md:h-28 md:mr-10 lg:w-32 lg:h-28 lg:mr-10">
        ...
        {/* Board 3 */}
        <div className="h-64 ml-8 bg-orange-300 border-8 border-orange-500 rounded-lg shadow-2xl w-80 shadow-orange-500/50 hover:scale-105 sm:w-28 sm:h-24 sm:-mr-20 md:w-32 md:h-28 md:-mr-20 lg:w-32 lg:h-28 lg:-mr-20">
          <div className="mt-16 w-28 h-28 ml-28 sm:ml-8 sm:mt-5 md:ml-8 md:mt-5 lg:ml-10 lg:mt-7">
